...
if calc_aic:
    ...
    for mod in models:
        for n_idx in range(node_n):
            print(n_idx)
            try:
                this_mod = MixedLMResults.load("{}{}/{}_reg70_byresp_lmm_{}{}.pickle".format(lmm_dir,band,mod,n_idx,z_name))
            except:
                continue
    ...
    with open("{}lmm/{}/aic_byresp_perm{}.pickle".format(proc_dir,band,z_name), "rb") as f:
