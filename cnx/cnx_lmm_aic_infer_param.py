...
if calc_aic:
    ...
    for mod in models:
        for n_idx in range(node_n):
            print(n_idx)
            try:
                this_mod = MixedLMResults.load("{}lmm/{}/{}_reg70_lmm_{}{}.pickle".format(proc_dir,band,mod,n_idx,z_name))
            except:
                continue
    ...
    with open("{}lmm/{}/aic{}.pickle".format(proc_dir,band,z_name), "wb") as f:
        pickle.dump(aic_comps,f)
else:
    with open("{}lmm/{}/aic{}.pickle".format(proc_dir,band,z_name), "rb") as f:
